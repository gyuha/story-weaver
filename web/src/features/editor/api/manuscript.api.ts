// editor(원고: 시놉시스·부·화·씬) 도메인 API facade — 생성 SDK(@/api)를 감싼다.
...
import {
  ...
  type DeleteApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdData,
  type DeleteApiV1WorksByWorkIdEpisodesByEpisodeIdData,
  type GetApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesData,
  ...
  type PatchApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdData,
  ...
  type PostApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesData,
  ...
  getApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenes,
  ...
  patchApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneId,
...
import {
  ...
  deleteApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdMutation,
  deleteApiV1WorksByWorkIdEpisodesByEpisodeIdMutation,
  getApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesOptions,
  ...
  patchApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdMutation,
  ...
  postApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesMutation,
...
export const manuscriptApi = {
  ...
  async scenes(
    options: Options<GetApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesData>
  ) {
  ...
  async createScene(
    options: Options<PostApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesData>
  ) {
  ...
  async updateScene(
    options: Options<PatchApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdData>
  ) {
    const { data } =
      await patchApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneId({
        ...options,
        throwOnError: true,
      });
    return data;
  ...
  async deleteScene(
    options: Options<DeleteApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdData>
  ) {
    const { data } =
      await deleteApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneId({
        ...options,
        throwOnError: true,
      });
    return data;
...
export const manuscriptQueries = {
  ...
  scenes: getApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesOptions,
};
...
export const manuscriptMutations = {
  ...
  createScene: postApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesMutation,
  updateScene: patchApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdMutation,
  deleteScene:
    deleteApiV1WorksByWorkIdEpisodesByEpisodeIdChaptersByChapterIdScenesBySceneIdMutation,
};
