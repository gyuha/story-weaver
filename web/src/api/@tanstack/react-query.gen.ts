 ...
 * 화 제목 생성 (SSE)
 */
export const postApiV1WorksByWorkIdScenesBySceneIdAssistTitleMutation = (options?: Partial<Options<PostApiV1WorksByWorkIdScenesBySceneIdAssistTitleData>>): UseMutationOptions<unknown, AxiosError<PostApiV1WorksByWorkIdScenesBySceneIdAssistTitleError>, Options<PostApiV1WorksByWorkIdScenesBySceneIdAssistTitleData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<PostApiV1WorksByWorkIdScenesBySceneIdAssistTitleError>, Options<PostApiV1WorksByWorkIdScenesBySceneIdAssistTitleData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiV1WorksByWorkIdScenesBySceneIdAssistTitle({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
